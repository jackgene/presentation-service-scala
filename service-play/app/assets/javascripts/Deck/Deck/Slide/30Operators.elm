    ...
    ( \page _ -> standardSlideView page heading
      ...
      ( div []
        ...
        , p []
          ...
          , text "For instance, while operators in the general API tend to use camel-case naming, RxPY takes the more Pythonic approach of using snake-case (preferring "
          , syntaxHighlightedCodeSnippet Python "flat_map(...)"
          , text " over "
          , syntaxHighlightedCodeSnippet Python "flatMap(...)"
          , text " for instance)."
          ]
        , p []
          [ text "RxPY "
          , syntaxHighlightedCodeSnippet Python "Observable"
          , text "s are also awaitable, allowing them to integrate nicely in an "
          , syntaxHighlightedCodeSnippet Python "asyncio"
          , text " application."
          ]
        , p []
